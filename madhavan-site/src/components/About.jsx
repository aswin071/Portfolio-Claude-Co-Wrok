      ...
      <div className="relative max-w-6xl mx-auto px-6 md:px-16">
        ...
        <div className="grid md:grid-cols-12 gap-10 md:gap-14 items-start">
          ...
          >
            ...
            >
              <span className="text-brand-gray text-sm font-medium">Follow me:</span>
              {[
                {
                  href: 'https://www.linkedin.com/in/madhavanunni/',
                  label: 'LinkedIn',
                  bg: 'bg-[#0A66C2]',
                  ring: 'ring-[#0A66C2]/30',
                ...
                {
                  href: 'https://www.instagram.com/madhavan__unni__/',
                  label: 'Instagram',
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className={`relative w-12 h-12 rounded-full ${social.bg} text-white flex items-center justify-center shadow-lg ring-4 ${social.ring} transition-shadow duration-300 hover:shadow-xl`}
                  aria-label={social.label}
                >
                  {/* Animated ping ring */}
                  <span className={`absolute inset-0 rounded-full ${social.bg} opacity-20 animate-ping`} style={{ animationDuration: '3s' }} />
